...
const Banner = () => {
    return (
        <div className='lg:flex lg:max-w-7xl p-8 mx-auto'>
            <div className='my-auto'>
                <h1 className='text-4xl text-center lg:text-start font-bold'>Are You Lost? Come Find Your 
                <br />
                ...
                <div className='mt-3'>
                    ...
                    <Link to="/about" className='font-bold ml-28 lg:ml-3'>Learn More</Link>
                </div>
            </div>
            <div className=''>
